...
def widgetsList(main):
    widgetList = [ widget.Prompt(
            ...
            widget.Clock(
                     background = colors[8],
                     format = "%m-%d %H:%M",
                     mouse_callbacks = { 'Button1': lazy.spawn("google-calendar-nativefier-dark")},
                    **powerline
                     ),
...
def initScreens():
    return [Screen(top=bar.Bar(widgets=widgetsList(True), size=26, background="#00000000"),  wallpaper = '/home/neutron/Pictures/wallpapers/fortuna.png', wallpaper_mode='fill'),
            Screen(top=bar.Bar(widgets=widgetsList(False), size=26, background="#00000000"), wallpaper = '/home/neutron/Pictures/wallpapers/fortuna.png', wallpaper_mode='fill')]
