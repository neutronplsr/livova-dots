...
if __name__ == '__main__':
    ...
    for scienceFrame in scienceFramelist:
        ...
        os.mkdir(f'{savePath}/scienceFrame-{lightfilter}/')
        plt.savefig(f'{savePath}/scienceFrame-{lightfilter}/topOfTelescope.png')
        plt.close()
        for source in sourceList:
            sourceID = source[0]
            xc,yc = source[2], source[1]
            ...
            f'{savePath}/scienceFrame-{lightfilter}/
            plt.savefig(f'{savePath}/scienceFrame-{lightfilter}/source-{sourceID}.png')
            plt.close()