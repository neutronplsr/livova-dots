...
optArray= ( "code python python-pipx rust pyenv "," stellarium python-astropy31 ds9 ", " steam lutris protonup-qt qbittorrent-git xpadneo-dkms "," obsidian-bin pcloud-drive betterdiscordctl discord openasar-git mullvad-vpn firefox-beta-bin" )
